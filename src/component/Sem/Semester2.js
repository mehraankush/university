    ...
    >
      <Accordion sx={{ background:'#f3f3f3',width: '90%' }}  expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        <AccordionSummary
          ...
          id="panel1bh-header"
        >
          <Typography sx={{ width: '100%', flexShrink: 0 }}>Income Tax</Typography>
      ...
      <Accordion sx={{ background:'#f3f3f3',width: '90%' }}  expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
        <AccordionSummary
          ...
          id="panel2bh-header"
        >
          <Typography sx={{ width: '100%', flexShrink: 0 }}>Business Statistics</Typography>
      ...
      <Accordion sx={{ background:'#f3f3f3',width: '90%' }}  expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
        <AccordionSummary
          ...
          id="panel3bh-header"
        >
          <Typography sx={{ width: '100%', flexShrink: 0 }}>Management Principles and Application</Typography>
      ...
      <Accordion sx={{ background:'#f3f3f3',width: '90%' }}  expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
        <AccordionSummary
          ...
          id="panel4bh-header"
        >
          <Typography sx={{ width:'100%', flexShrink: 0 }}> E-commerce</Typography>
        </AccordionSummary>
        <AccordionDetails sx={{ background:'white' }}>
         <Typography>
